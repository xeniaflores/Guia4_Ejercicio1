...
export class AppComponent {
  title = 'CrudAngular';
  alumnoArray: Alumno[] = [
    {id:1, name:"Alex", lastname:"Campos",age:35,direccion:"San Salvador", telefono:"7548-3652", correo:"alex@gmail.com"},
    {id:2, name:"Maria",lastname:"Lopez",age:20,direccion:"Sonsonate", telefono:"7243-9636", correo:"maria@gmail.com"},
    {id:3, name:"Juan", lastname:"Castro",age:25,direccion:"San Miguel", telefono:"7785-9631", correo:"juan@gmail.com"}
    ]
